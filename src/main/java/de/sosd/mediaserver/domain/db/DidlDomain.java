...
public class DidlDomain implements Serializable {
    ...
    private final List<DidlDomain> containerContent  = new ArrayList<DidlDomain>(
                                                             5);
    ...
    private final List<DidlDomain> references        = new ArrayList<DidlDomain>(
                                                             5);
    ...
    public DidlDomain(final String title, final FileDomain file,
            final ClassNameWcType classType, final String url,
            final String protocolInfo, final DidlDomain parent) {
    ...
    public DidlDomain(final ScanFolderDomain folder, final DidlDomain parent) {
        this(folder.getId(), folder.getName(), folder.getPath(),
                ClassNameWcType.OBJECT_CONTAINER_STORAGE_VOLUME, parent);
    ...
    public DidlDomain(final SystemDomain system) {
        this(system.getUsn(), "/", "root",
                ClassNameWcType.OBJECT_CONTAINER_STORAGE_SYSTEM, null);
        setPath(system.getUsn() + ":");
        system.setDidlRoot(this);

        system.addFolder(
                new DidlDomain(UUID.randomUUID().toString(), "Filesystem",
                        "The Filesystem",
                        ClassNameWcType.OBJECT_CONTAINER_STORAGE_VOLUME, this)
                );
    }

    public DidlDomain(final String id, final String title,
            final String description, final ClassNameWcType classType,
    ...
    /**
     * @param nrAudioChannels
     *            the nrAudioChannels to set
     */
    ...
    public Integer getContainerContentSize() {
        if (this.containerContentSize == null) {
            setContainerContentSize(getContainerContent().size());
        }
        return this.containerContentSize;
    }

    public void setContainerContentSize(final Integer containerContentSize) {
    ...
    public void increaseUpdateId() {
        if (!this.updateIdIncreased) {
            setUpdateId(getUpdateId() + 1);
            this.updateIdIncreased = true;
    ...
    public boolean isContainer() {
        ...
        case OBJECT_CONTAINER_STORAGE_VOLUME:
            return true;
        case OBJECT_ITEM:
        ...
        case OBJECT_ITEM_VIDEO_ITEM_VIDEO_BROADCAST:
            return false;
        default:
            return !getContainerContent().isEmpty();
        }
    }
    ...
    /*
     * 
     * <item id="{A8379C6F-6CDC-4367-ABE4-064569E67404}.0.6BA8E00E"
     * refID="{A8379C6F-6CDC-4367-ABE4-064569E67404}.0.8" restricted="1"
     * parentID="6BA8E00E"> <dc:title>5.Days.of.War</dc:title>
     * <dc:creator>[Unbekannter Autor]</dc:creator> <res size="1469855744"
     * duration="1:48:26.000" bitrate="225923" resolution="704x288"
     * protocolInfo=
     * "http-get:*:video/avi:DLNA.ORG_OP=01;DLNA.ORG_FLAGS=01500000000000000000000000000000"
     * sampleFrequency="48000" bitsPerSample="16" nrAudioChannels="6"
     * microsoft:codec="{5634504D-0000-0010-8000-00AA00389B71}"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * 0_e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ.avi</res>
     * <res duration="1:48:26.000" bitrate="379846" resolution="352x480"
     * protocolInfo=
     ...
     * nrAudioChannels="2"
     * microsoft:codec="{E06D8026-DB46-11CF-B4D1-00805F6CBBEA}"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .mpg?formatID=29</res> <res duration="1:48:26.000" bitrate="379846"
     * resolution="352x576" protocolInfo=
     ...
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .mpg?formatID=35</res> <res duration="1:48:26.000" bitrate="193923"
     * resolution="704x288" protocolInfo=
     ...
     * microsoft:codec="{31435657-0000-0010-8000-00AA00389B71}"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .asf?formatID=40</res> <res duration="1:48:26.000" bitrate="193923"
     * resolution="704x288" protocolInfo=
     ...
     * microsoft:codec="{31435657-0000-0010-8000-00AA00389B71}"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * >rtsp://192.168.101.227:554/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .asf?formatID=41</res> <res duration="1:48:26.000" bitrate="56250"
     * resolution="704x288" protocolInfo=
     ...
     * sampleFrequency="48000" nrAudioChannels="2"
     * microsoft:codec="{33564D57-0000-0010-8000-00AA00389B71}"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .wmv?formatID=70</res> <res duration="1:48:26.000" bitrate="56250"
     * resolution="704x288" protocolInfo=
     ...
     * >rtsp://192.168.101.227:554/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .wmv?formatID=71</res> <res duration="1:48:26.000" bitrate="37500"
     * resolution="352x144" protocolInfo=
     ...
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .wmv?formatID=80</res> <res duration="1:48:26.000" bitrate="37500"
     * resolution="352x144" protocolInfo=
     ...
     * >rtsp://192.168.101.227:554/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .wmv?formatID=81</res> <upnp:class>object.item.videoItem</upnp:class>
     * <upnp:genre>[Unbekanntes Genre]</upnp:genre> <upnp:artist
     * role="Performer">[Unbekannter Autor]</upnp:artist>
     * <upnp:album>[Unbekannte Serie]</upnp:album> <dc:date>2011-06-14</dc:date>
     * <upnp:actor>[Unbekannter Autor]</upnp:actor>
     * <upnp:scheduledStartTime>2011-06-14T20:21:00</upnp:scheduledStartTime>
     * <upnp:albumArtURI dlna:profileID="JPEG_SM"
     * xmlns:dlna="urn:schemas-dlna-org:metadata-1-0/"
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * 0_e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ.jpg?albumArt=true</upnp:albumArtURI>
     * <upnp:albumArtURI dlna:profileID="JPEG_TN"
     * xmlns:dlna="urn:schemas-dlna-org:metadata-1-0/"
     * >http://192.168.101.227:10243/WMPNSSv4/2341708733/
     * e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ
     * .jpg?albumArt=true,formatID=13</upnp:albumArtURI> <desc id="artist"
     * nameSpace="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/">
     * <microsoft:artistPerformer>[Unbekannter
     * Autor]</microsoft:artistPerformer> </desc> <desc id="UserRating"
     * nameSpace="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/">
     * <microsoft:userEffectiveRatingInStars
     * >3</microsoft:userEffectiveRatingInStars>
     * <microsoft:userEffectiveRating>50</microsoft:userEffectiveRating> </desc>
     * <desc id="folderPath" nameSpace="urn:schemas-microsoft-com:WMPNSS-1-0/"
     * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/">
     * <microsoft:folderPath>Filme</microsoft:folderPath> </desc> </item>
     */
    ...
    private void containerIntoDidl(final StringBuilder out,
            final DidlXmlCreator helper) {
        // <container id="0$0$0$0" childCount="0" parentID="0$0$0"
        // restricted="true">
    ...
    private void itemIntoDidl(final StringBuilder out,
            final DidlXmlCreator helper) {
        // write node and attributes
        out.append("<item id=\"");
        out.append(helper.translateId(this));
    ...
    private void addFolderPathMS(final StringBuilder out) {
         ...
         * nameSpace="urn:schemas-microsoft-com:WMPNSS-1-0/"
         * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/">
         * <microsoft:folderPath>Filme</microsoft:folderPath> </desc>
         */
        if (getParent() != null) {
    ...
    private void addScheduledStartTime(final StringBuilder out,
            final DidlXmlCreator helper) {
        // <upnp:scheduledStartTime>2011-06-14T20:21:00</upnp:scheduledStartTime>
    ...
    private void addAlbumArtURI(final StringBuilder out,
            final DidlXmlCreator helper) {
        /*
         * <upnp:albumArtURI dlna:profileID="JPEG_SM"
         * xmlns:dlna="urn:schemas-dlna-org:metadata-1-0/" >
         * http://192.168.101.227:10243/WMPNSSv4/2341708733/
         * 0_e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ.jpg?albumArt=true
         * </upnp:albumArtURI>
         */
    ...
    private void addArtistMS(final StringBuilder out) {
         ...
         * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/">
         * <microsoft:artistPerformer>[Unbekannter
         * Autor]</microsoft:artistPerformer> </desc>
         */
        if (getArtist() != null) {
    ...
    private void addTrack(final StringBuilder out) {
    ...
    private void addStreamRes(final StringBuilder out,
            final DidlXmlCreator helper) {
        /*
         * <res size="1469855744" duration="1:48:26.000" bitrate="225923"
         * resolution="704x288" protocolInfo=
         * "http-get:*:video/avi:DLNA.ORG_OP=01;DLNA.ORG_FLAGS=01500000000000000000000000000000"
         * sampleFrequency="48000" bitsPerSample="16" nrAudioChannels="6"
         * microsoft:codec="{5634504D-0000-0010-8000-00AA00389B71}"
         * xmlns:microsoft="urn:schemas-microsoft-com:WMPNSS-1-0/" >
         * http://192.168.101.227:10243/WMPNSSv4/2341708733/
         * 0_e0E4Mzc5QzZGLTZDREMtNDM2Ny1BQkU0LTA2NDU2OUU2NzQwNH0uMC42QkE4RTAwRQ.avi
         * </res>
         */
    ...
    private void addThumbRes(final StringBuilder out,
            final DidlXmlCreator helper) {
        /*
         * <res protocolInfo=
         * "http-get:*:image/jpeg:DLNA.ORG_PN=JPEG_TN;DLNA.ORG_CI=1;DLNA.ORG_FLAGS=00f00000000000000000000000000000"
         * > http://192.168.101.50:9000/disk/DLNA-PNJPEG_TN-CI1-FLAGS00f00000/
         * defaultalbumart/v_i_d_e_o.jpg/O0$3$27I1293.jpg?scale=160x160 </res>
         */
    ...
    public boolean removeChild(final DidlDomain item) {
    ...
    public boolean addChild(final DidlDomain item) {
    ...
    private String getXmlString(final String str) {
        return StringEscapeUtils.escapeXml(new String(str
                .getBytes(DidlXmlCreator.utf8), DidlXmlCreator.utf8));
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final DidlDomain other = (DidlDomain) obj;
        if (this.id == null) {
            if (other.id != null) {
                return false;
            }
    ...
    public String toString() {
        return "DidlDomain ["
                ...
                + (this.videoCodec != null ? "videoCodec=" + this.videoCodec
                        + ", " : "")
                + (this.audioCodec != null ? "audioCodec=" + this.audioCodec
                        + ", " : "")
