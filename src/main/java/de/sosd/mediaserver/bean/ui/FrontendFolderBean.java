...
public class FrontendFolderBean {
    ...
    public FrontendFolderBean(final String folderPath) {
        ...
        this.overallSize = 0l + this.fileCount * (r.nextInt(200) + 1) * 1024
                * 1024;
    }

    public FrontendFolderBean(final String id, final String path,
    ...
    public FrontendFolderBean(final String id, final String path,
            final Date lastScan,
            final int scanInterval, final ScanFolderState scanState,
            final int folderCount,
            final int fileCount, final long overallSize) {
        super();
        setId(id);
