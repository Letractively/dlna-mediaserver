...
public class IdService {
    ...
    public String getId(final File f) {
        try {
            ...
            logger.error(
                    "error while computing file-id for " + f.getAbsolutePath(),
                    t);
        }
        return null;
    ...
    public String getUUID(final File f) throws NoSuchAlgorithmException,
            IOException {
        return getId4File(f);
    }

    private String getId4Directory(final File directory)
