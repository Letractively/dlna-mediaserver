...
public class TestSoap {
	 ...
	 */
	public static void main(final String[] args) throws JAXBException, URISyntaxException {
//		// create JAXB context and instantiate marshaller
//		PreferredNamespaceMapper preferredNamespaceMapper = new de.sosd.mediaserver.xml.PreferredNamespaceMapper();
//		JAXBContext context = JAXBContext.newInstance(BrowseResponse.class);
//	
//		Marshaller m = context.createMarshaller();
//		m.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
//		m.setProperty("com.sun.xml.internal.bind.namespacePrefixMapper", preferredNamespaceMapper);
...
//			System.out.println();
//			
//			 context = JAXBContext.newInstance("org.upnp.schemas.metadata_1_0.didl_lite");
//				m = context.createMarshaller();
//				
//				m.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
//				m.setProperty("com.sun.xml.internal.bind.namespacePrefixMapper", preferredNamespaceMapper);
...
////					m.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
////					m.setProperty("com.sun.xml.bind.namespacePrefixMapper", preferredNamespaceMapper);
...
////					 
////					 context = JAXBContext.newInstance(org.upnp.schemas.service.contentdirectory._1.BrowseResponse.class);
////						m = context.createMarshaller();
////						
////						m.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
////						m.setProperty("com.sun.xml.bind.namespacePrefixMapper", preferredNamespaceMapper);
////						org.upnp.schemas.service.contentdirectory._1.BrowseResponse br = new org.upnp.schemas.service.contentdirectory._1.BrowseResponse();
////						
...
//	}
//
//	private static void fillResponse(BrowseResponse response) throws URISyntaxException {
...
//		((DidleLite) response.getResult().getItem()).getContainerList().add(didleContainer);
...
//		didleContainer.getResources().add(new URI("http://www.test.de:8080/dl/item?1"));
//	}
